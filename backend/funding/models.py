...
class FundingOpportunity(models.Model):
    ...
    funders_url = models.URLField(max_length=1000, null=True, blank=True)
    funding_type = models.CharField(max_length=150, null=True, blank=True)
    total_fund = models.DecimalField(
                                max_digits=15,
                                decimal_places=2,
                                null=True, blank=True)
    award_range = models.CharField(max_length=500, null=True, blank=True)
